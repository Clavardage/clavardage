...
public class MyJScrollBarUI extends BasicScrollBarUI {
    ...
    protected void paintTrack(Graphics g, JComponent c, Rectangle r) {
        ...
        Color color = Application.getCOLOR_SCROLL_BAR();
        g2.setPaint(color);
        g2.fillRoundRect(r.x,r.y,r.width,r.height,25,25);
        g2.setPaint(Application.getCOLOR_BACKGROUND());
        g2.drawRoundRect(r.x,r.y,r.width,r.height,25,25);
        g2.setBackground(Application.getCOLOR_BACKGROUND());
        g2.dispose();
    }
    ...
    protected void paintThumb(Graphics g, JComponent c, Rectangle r) {
      ...
      if(!sb.isEnabled() || r.width>r.height) {
        ...
        color = Application.getCOLOR_CURSOR_SCROLL_HOVER();
      }else if(isThumbRollover()) {
        color = Application.getCOLOR_CURSOR_SCROLL_HOVER();
      }else {
        color = Application.getCOLOR_CURSOR_SCROLL();
      }
      g2.setPaint(color);
      g2.fillRoundRect(r.x+4,r.y,r.width-8,r.height,20,20);
      g2.setPaint(Application.getCOLOR_CURSOR_SCROLL());
